...
const FindRoommate = () => {
    ...
    const handelAddToFindMate = (e) => {
        ...
        fetch('https://roommate-web-a10-server.vercel.app/roommates', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(newPostedData)
        })
            .then(res => res.json())
            .then((data) => {
                        ...
                        <div className="card-body">
                            ...
                            <form onSubmit={handelAddToFindMate} >
                                ...
                                <div className='px-2 md:px-4 lg:px-8 pb-1.5 md:pb-2'>
                                    ...
                                    <input name='PhotoURL' type="text" className="input w-full" placeholder=" (PhotoURL)" />
                                </div>
